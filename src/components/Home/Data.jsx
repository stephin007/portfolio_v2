  ...
  return (
    <div className='home__data'>
      ...
      <p className='home__description'>
        A proficient Solution Engineer with expertise in web development, adept
        at crafting and executing effective web solutions that meet business
        needs. Proficient in programming languages such as HTML, CSS,
        JavaScript, and React, I offer technical guidance and support throughout
        the development cycle. My analytical skills and meticulous approach
        guarantee on-time and on-budget project completion.
      </p>
